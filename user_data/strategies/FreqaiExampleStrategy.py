...
class FreqaiExampleStrategy(IStrategy):
    ...
    def custom_stoploss(self, pair: str, trade: Trade, current_time: datetime,
        ...
        if atr > 0 and current_rate > 0:
            ...
            # Lógica de clamp con negativos:
            # min(..., -0.005) limita el stop mínimo a -0.5% (ej. si atr_stop es -0.001, devuelve -0.005)
            # max(..., -0.03) limita la pérdida máxima a -3.0% (ej. si atr_stop es -0.10, devuelve -0.03)
